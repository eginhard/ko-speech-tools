...
def parse_table():
    ...
    with open(os.path.dirname(os.path.abspath(__file__)) + '/../data/g2p/table.csv', 'r', encoding='utf8') as f:
...
def get_rule_id2text():
    '''for verbose=True'''
    with open(os.path.dirname(os.path.abspath(__file__)) + '/../data/g2p/rules.txt', 'r', encoding='utf8') as f:
